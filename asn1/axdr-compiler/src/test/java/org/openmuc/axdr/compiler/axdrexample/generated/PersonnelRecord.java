...
public class PersonnelRecord implements AxdrType {
    ...
    public AxdrOptional<AxdrVisibleString> title = new AxdrOptional<>(new AxdrVisibleString(), false);
    ...
    public AxdrDefault<AxdrBoolean> stillEmployed = new AxdrDefault<>(new AxdrBoolean(), new AxdrBoolean(true));
    ...
    public PersonnelRecord(Name name, AxdrVisibleString title, EmployeeNumber number, Date dateOfHire,
            Name nameOfSpouse, SubSeqOfChildren children, AxdrBoolean stillEmployed) {
        this.name = name;
    ...
    public int decode(InputStream iStream) throws IOException {
        ...
        title = new AxdrOptional<>(new AxdrVisibleString(), false);
        ...
        stillEmployed = new AxdrDefault<>(new AxdrBoolean(), new AxdrBoolean(true));
    ...
    public String toString() {
        return "sequence: {" + "name: " + name + ", title: " + title + ", number: " + number + ", dateOfHire: "
                + dateOfHire + ", nameOfSpouse: " + nameOfSpouse + ", children: " + children + ", stillEmployed: "
                + stillEmployed + "}";
    }
