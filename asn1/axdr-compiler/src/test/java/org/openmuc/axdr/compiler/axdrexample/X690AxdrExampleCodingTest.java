...
public class X690AxdrExampleCodingTest {
    ...
    public void encodingDecoding() throws IOException {
        ...
        assertArrayEquals("20081028".getBytes(charset), psType_decoded.children.get(1).dateOfBirth.getValue());
        assertArrayEquals("Melissa".getBytes(charset), psType_decoded.nameOfSpouse.givenName.getValue());
        assertEquals(123456, psType_decoded.number.getValue());
        assertEquals(true, psType_decoded.stillEmployed.getValue().getValue());
