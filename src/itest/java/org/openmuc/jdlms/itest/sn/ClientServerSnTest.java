...
import org.openmuc.jdlms.itest.ITestHelper;
...
public class ClientServerSnTest {
    ...
    public void setup() throws Exception {
        ...
        this.dlmsServer = DlmsServer.tcpServerBuilder(port)
    ...
    private static TcpConnectionBuilder setupConnectionParams() throws UnknownHostException {
        return new TcpConnectionBuilder("127.0.0.1").setPort(port).setReferencingMethod(SHORT);
    }
