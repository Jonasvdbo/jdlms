...
public class ClientServerLnParalellTest {
    ...
    private static final int PORT = ITestHelper.getAvailablePort();
    ...
    public static void setupServer() throws Exception {
        ...
        server = DlmsServer.tcpServerBuilder(PORT)
                .setMaxClients(C_CLIENTS)
                .registerLogicalDevice(logicalDevice1)
                .build();
    }
    ...
    private class R1 implements Callable<Void> {
        ...
        public Void call() throws Exception {
            DlmsConnection conn = new TcpConnectionBuilder("localhost").setPort(PORT).build();
