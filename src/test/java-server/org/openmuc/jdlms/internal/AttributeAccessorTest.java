...
public class AttributeAccessorTest {
    ...
    private static FieldAccessor setupFieldAccessor(String fieldname) throws NoSuchFieldException {
        Field field = T1.class.getDeclaredField(fieldname);
