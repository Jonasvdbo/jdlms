...
public class RangeTest {
    ...
    @ParameterizedTest
    @MethodSource("intersectTestParams")
    ...
    static public Object intersectTestParams() {
    ...
    @ParameterizedTest
    @MethodSource("rangeIntersectTestParams")
    ...
    static public Object rangeIntersectTestParams() {
