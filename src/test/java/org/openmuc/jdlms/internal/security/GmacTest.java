...
import static org.openmuc.jdlms.HexConverter.fromShortHexString;
...
public class GmacTest {
    ...
    public void doGmacTestFromStandardExample() throws Exception {
        ...
        byte[] challenge = fromShortHexString("503677524A323146");
        byte[] encryptionKey = fromShortHexString("000102030405060708090A0B0C0D0E0F");
        byte[] authenticationKey = fromShortHexString("D0D1D2D3D4D5D6D7D8D9DADBDCDDDEDF");
        byte[] systemTitle = fromShortHexString("4d4d4d0000000001");
        int frameCounter = 1;
        ...
        byte[] fStoCFromStandard = fromShortHexString("10000000011A52FE7DD3E72748973C1E28");
