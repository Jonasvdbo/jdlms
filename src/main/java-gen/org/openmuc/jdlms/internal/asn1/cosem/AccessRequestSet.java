...
public class AccessRequestSet implements AxdrType {

    public byte[] code = null;
    public CosemAttributeDescriptor cosemAttributeDescriptor = null;

    public AccessRequestSet() {
    }

    public AccessRequestSet(byte[] code) {
        this.code = code;
    }

    public AccessRequestSet(CosemAttributeDescriptor cosemAttributeDescriptor) {
