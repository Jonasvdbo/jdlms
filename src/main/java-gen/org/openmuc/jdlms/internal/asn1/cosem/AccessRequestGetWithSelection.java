...
public class AccessRequestGetWithSelection implements AxdrType {
    ...
    public AccessRequestGetWithSelection() {
    }

    public AccessRequestGetWithSelection(byte[] code) {
        this.code = code;
    }

    public AccessRequestGetWithSelection(CosemAttributeDescriptor cosemAttributeDescriptor,
