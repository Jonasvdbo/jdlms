...
public class ActionResponseNextPblock implements AxdrType {
    ...
    public ActionResponseNextPblock(byte[] code) {
        this.code = code;
    }

    public ActionResponseNextPblock(InvokeIdAndPriority invokeIdAndPriority, Unsigned32 blockNumber) {
