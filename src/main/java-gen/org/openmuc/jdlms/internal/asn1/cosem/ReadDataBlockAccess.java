...
public class ReadDataBlockAccess implements AxdrType {
    ...
    public ReadDataBlockAccess() {
    }

    public ReadDataBlockAccess(byte[] code) {
        this.code = code;
    }

    public ReadDataBlockAccess(AxdrBoolean lastBlock, Unsigned16 blockNumber, AxdrOctetString rawData) {
