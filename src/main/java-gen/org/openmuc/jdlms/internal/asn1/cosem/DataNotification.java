...
public class DataNotification implements AxdrType {
    ...
    public DataNotification(Unsigned32 longInvokeIdAndPriority, AxdrOctetString dateTime,
    ...
    public int encode(ReverseByteArrayOutputStream axdrOStream) throws IOException {
        ...
        if (code != null) {
            ...
            codeLength = 0;
            codeLength += notificationBody.encode(axdrOStream);
    ...
    public int decode(InputStream iStream) throws IOException {
        ...
        codeLength += notificationBody.decode(iStream);
