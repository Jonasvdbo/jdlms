...
public class SetResponseNormal implements AxdrType {
    ...
    public SetResponseNormal(byte[] code) {
        this.code = code;
    }

    public SetResponseNormal(InvokeIdAndPriority invokeIdAndPriority, AxdrEnum result) {
