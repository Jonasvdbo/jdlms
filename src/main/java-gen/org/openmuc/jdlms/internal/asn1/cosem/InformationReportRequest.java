...
public class InformationReportRequest implements AxdrType {
    ...
    public AxdrOptional<AxdrGeneralizedTime> currentTime = new AxdrOptional<>(new AxdrGeneralizedTime(), false);
    ...
    public InformationReportRequest(AxdrGeneralizedTime currentTime,
            SubSeqOfVariableAccessSpecification variableAccessSpecification, SubSeqOfListOfData listOfData) {
    ...
    public int encode(ReverseByteArrayOutputStream axdrOStream) throws IOException {
        ...
        if (code != null) {
            ...
            codeLength += currentTime.encode(axdrOStream);
    ...
    public int decode(InputStream iStream) throws IOException {
        ...
        currentTime = new AxdrOptional<>(new AxdrGeneralizedTime(), false);
        codeLength += currentTime.decode(iStream);
    ...
    public String toString() {
        return "sequence: {" + "currentTime: " + currentTime + ", variableAccessSpecification: "
                + variableAccessSpecification + ", listOfData: " + listOfData + "}";
    }
