...
public class ActionRequestNextPblock implements AxdrType {
    ...
    public ActionRequestNextPblock(byte[] code) {
        this.code = code;
    }

    public ActionRequestNextPblock(InvokeIdAndPriority invokeIdAndPriority, Unsigned32 blockNumber) {
