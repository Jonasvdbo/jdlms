...
public class ActionResponseWithPblock implements AxdrType {
    ...
    public ActionResponseWithPblock(byte[] code) {
        this.code = code;
    }

    public ActionResponseWithPblock(InvokeIdAndPriority invokeIdAndPriority, DataBlockSA pblock) {
