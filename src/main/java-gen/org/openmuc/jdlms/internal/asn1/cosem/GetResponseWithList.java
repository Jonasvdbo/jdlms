...
public class GetResponseWithList implements AxdrType {
    ...
    public static class SubSeqOfResult extends AxdrSequenceOf<GetDataResult> {
        ...
        @Override
        protected GetDataResult createListElement() {
    ...
    public GetResponseWithList(byte[] code) {
        this.code = code;
    }

    public GetResponseWithList(InvokeIdAndPriority invokeIdAndPriority, SubSeqOfResult result) {
