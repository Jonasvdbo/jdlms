...
public class LogicalDevice {
    ...
    public LogicalDevice(int logicalDeviceId, String logicalDeviceName, String manufacturerId, long deviceId) {
        ...
        setConformance(GET, SET, ACTION, BLOCK_TRANSFER_WITH_GET_OR_READ, BLOCK_TRANSFER_WITH_SET_OR_WRITE,
                BLOCK_TRANSFER_WITH_ACTION, MULTIPLE_REFERENCES, READ, WRITE, SELECTIVE_ACCESS, PARAMETERIZED_ACCESS);
    }
